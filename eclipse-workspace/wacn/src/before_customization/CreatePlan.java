...
public class CreatePlan {
	...
	public static void main(String[] args) throws IOException {
		...
		changedListMap.put("virtual-network",      new CreatePlan_azure_signalr().getChangedFilesList("virtual-network"));
		changedListMap.put("governance",      new CreatePlan_azure_signalr().getChangedFilesList("governance"));
